...
# JL_dStage_dt_timeseries <- ggplot(data = temp3 %>%
#                                     filter(Catchment == "Jackson Lane"),
#                                   mapping = aes(x = Date,
#                                                 y = dStage_dt,
#                                                 color = lag_window_num)) +
#   geom_line() +
...
# BC_dStage_dt_timeseries <- ggplot(data = temp4,
#                                   mapping = aes(x = Date,
#                                                 y = dStage_dt,
#                                                 color = lag_window_num)) +
#   geom_line() +
...
# Stage_timeseries <- ggplot(data = temp5,
#                            mapping = aes(x = Date,
...
#Facet by lookback window
gradient_hydro_regime_box2 <- ggplot(data = temp_boxplot,
                                    mapping = aes(x = hydro_regime,
                                                  y = head_gradient_cm_m,
                                                  fill = Relationship)) +
  geom_boxplot() +
  ...
  theme(legend.position = "bottom",
        ...
        strip.text = element_text(size = 12,
                                  face = "bold")) +
  facet_wrap(vars(lag_window_regime),
             scales = "fixed") +
  scale_fill_brewer(palette = "Set1")

(gradient_hydro_regime_box2)
